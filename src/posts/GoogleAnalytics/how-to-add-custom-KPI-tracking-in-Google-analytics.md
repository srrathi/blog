...
category: [internet]
---
> TL;DR: I sent data through an AJAX request to an end point of google analytics. Follow [this article](/send-custom-events-to-firebase) for step-by-step instructions
